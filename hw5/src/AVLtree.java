...
class Node_tree<K extends Comparable<K>, V extends Comparable<V>> extends LinkedList<V>{
    ...
    public final void addItem(V obj){super.add(obj);}
    public Node_tree<K, V> addNode(Node_tree<K, V> child){ // returns added node
        if(this.keyBiggerThan(child)){
            if(this.getLeft() == null){
                this.setLeft(child);
                child.setParent(this);
            }else{return this.getLeft().addNode(child);}
        }else{
            if(this.getRight() == null){
                this.setRight(child);
                child.setParent(this);
            }else{return this.getRight().addNode(child);}
        }
        return child;
    }
    ...
    public final void rotateLL(){
        ...
        if(node_l.getRight() != null){node_l.getRight().setParent(this);}
    ...
    public final void rotateRR(){
        ...
        if(node_r.getLeft() != null){node_r.getLeft().setParent(this);}
    ...
    public final int getBF() {return this.getHeightL() - this.getHeightR();}
    ...
    public final boolean keyBiggerThan(Node_tree<K, V> obj){
        ...
        if(this.getKey().compareTo(obj.getKey()) > 0){return true;}else{return false;}
    }
    ...
    public final boolean keyBiggerThan(K key){
        if(this.getKey().compareTo(key) > 0){return true;}else{return false;}
    }
